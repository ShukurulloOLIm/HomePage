...
const games = () => {
    ...
    if (lang == 'uk') {
        ...
        games.innerHTML = `<a href='https://shukurulloolim.github.io/sqrt/'><button id='selectionButtons' style='--order: 1' class='drop1'><div class='main-box'><img src='Images/sqrt.png' alt='sqrt' class='sqrtImage'><div class='Card-body'><h3 class='Title'>F Sqrt</h3><div class='smallerbox'></div></div></div></button></a><a href='https://shukurulloolim.github.io/math/'><button id='selectionButtons' style='--order: 2' class='drop1'> <div class='main-box'> <img src='Images/math.png' alt='sqrt' class='cbrtImage'> <div class='Card-body'><h3 class='Title'>暗算ゲーム</h3><div class='smallerbox'></div></div></div></button></a>`;
    };
